...
@section('title', 'Composer Votes And Proceedings')
    ...
    <div class="content-frame">
        ...
        <div class="content-frame-top">
            <div class="page-title">
                <h2><span class="fa fa-pencil"></span> Upload Votes And Proceeding</h2>
            </div>
        </div>
            ...
            <div class="block">
                @if($encodeId)
                    <div class="list-group border-bottom">
                        <a href="{{ url('/vote-proceedings/roll-call/' . $encodeId) }}" class="list-group-item active"><span class="fa fa-inbox"></span> Take Roll Call</a>
                    </div>
                @endif
                <h4>Statistics</h4>
        ...
        <div class="content-frame-body">
            <div class="block">
                ...
                <form role="form" action="{{ url('/vote-proceedings/create') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div class="col-md-10">
                            <div class="pull-right">
                                <button class="btn btn-primary"><span class="fa fa-save"></span> Save Votes And Proceedings
                                </button>
                            </div>
                        </div>
                    </div>
...
@section('custom_script')
    ...
    <script>
        jQuery(document).ready(function () {
            setTabActive('[href="/vote-proceedings/create"]');
        });
    </script>
@endsection