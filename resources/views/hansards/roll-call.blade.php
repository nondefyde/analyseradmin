...
@section('title', 'Hansard Roll Calls')
...
@section('content')
    ...
    <div class="page-title">
        <h2><span class="fa fa-plus-square"></span> Hansard Roll Calls</h2>
    </div>
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default form-horizontal">
                    <div class="panel-body">
                        <h3><span class="fa fa-info-circle"></span> Hansard Info</h3>
                    </div>
                    <div class="col-md-4">
                        <div class="panel-body form-group-separated">
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-7 line-height-30">Vol. {{ $hansard->volume }}</div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-xs-5 control-label">Number: </label>

                                <div class="col-md-8 col-xs-7 line-height-30">No. {{ $hansard->number }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="panel-body form-group-separated">
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-7 line-height-30">{{ $hansard->user()->first()->fullNames() }}</div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-xs-5 control-label">Date: </label>

                                <div class="col-md-8 col-xs-7 line-height-30">{{ $hansard->date->format('D, jS M, Y') }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="panel-body form-group-separated">
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-xs-7 line-height-30">{{ $hansard->house()->first()->house }}</div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-xs-5 control-label">Session: </label>

                                <div class="col-md-8 col-xs-7 line-height-30">{{ $hansard->session }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">List of {{ $hansard->house()->first()->userType()->first()->user_type }} for Roll Calls</h3>
                    ...
                    <div class="panel-body">
                        ...
                        !!}
                        <input type="hidden" name="hansard_id" value="{{ $hansard->hansard_id }}"/>
