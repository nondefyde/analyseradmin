...
function setTabActive(link){
    $('ul.x-navigation li.active, ul.x-navigation li ul li.active, ul.x-navigation li ul li ul li.active').each(function(){
        $(this).removeClass('active');
    });
    var sub_submenu = $(link).parent();
    var submenu = $(link).parent().parent().parent();
    var mainmenu = $(link).parent().parent().parent().parent().parent();
    sub_submenu.addClass('active');
